...
//    [self.navigationItem setRightBarButtonItem:cancelButton animated:NO];
    [self.imagePickerController setupRightBarButtonItem:self.imagePickerController withAction:@selector(cancel:) withViewController:self];
...
-(void)updateToolbar{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        sendBBI.badgeValue = [NSString stringWithFormat:@"%d",(int)[self.imagePickerController.selectedAssetURLs count]];
    });
