...
+(void) post:(NSString*)uri Parameters:(NSDictionary *)parameters  success:(void (^)(id json))success failure:(void (^)(id json))failure withView:(UIView*)view{
    [RLBaseLogic post:uri Parameters:parameters success:success failure:failure connectionError:failure withView:view];
}
...
//    NSString* urlStr=[NSString stringWithFormat:@"%@%@",API,uri];
    ...
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    manager.responseSerializer.acceptableContentTypes=[NSSet setWithObjects:@"application/json",@"text/xml",@"text/html", nil];
