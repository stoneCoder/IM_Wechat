...
#define kGradientBottomColor [UIColor redColor]
...
#define kGradientTopColor   [UIColor redColor]
...
//normal text font
//#define kTextFont [UIFont fontWithName:@"HelveticaNeue" size:14.f]
#define kTextFont     [UIFont boldSystemFontOfSize:14.0]
