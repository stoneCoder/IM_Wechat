...
-(void)setupHeaderView{
    ...
    self.headerView.titleTextField.placeholder = @"";
    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            case 0:
                ...
                blockCell.detailTextLabel.text = _nickname;
//                [RACObserve(_friendInfo, name) subscribeNext:^(NSString *name){
//                    blockCell.detailTextLabel.text = name;
//                }];
                break;
            case 1:
                ...
                if ([self.memberVO.affiliation isEqualToString:@"20"]) {
                    ...
                    blockCell.detailTextLabel.text = @"群主";
                }else{
