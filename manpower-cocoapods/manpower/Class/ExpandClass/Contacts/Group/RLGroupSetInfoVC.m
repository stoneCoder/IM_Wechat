...
-(void)bindValuesToView{
    ...
    [RACObserve(group, photo) subscribeNext:^(NSString *newString){
        ...
        [self.headerView.photoIV sd_setImageWithURL:url placeholderImage:IMAGE_DEFAULT_ROOM];
    }];
...
-(void)changeButtonFunction:(NSDictionary *)dict
{
    if (self.createFlag == 0) {
        ...
        self.finishButton.frame = CGRectMake(9, 50, 302, 44);
    ...
    }else if(self.createFlag == 2) /*通过发送群消息界面进入*/
    {
        ...
        if (self.isOwner == 0 /*|| self.isOwner == 1*/) {
            ...
            self.dismissButton.frame = CGRectMake(164, 50, 147, 44);
        ...
        }else if(self.isOwner != 3)
        {
            ...
            self.quitButton.frame = CGRectMake(164, 50, 147, 44);
        ...
        }else if(self.isOwner == 3)
        {
            ...
            self.registeButton.frame = CGRectMake(9, 50, 302, 44);
        ...
        if (self.isOwner != 3) {
            ...
            self.sendButton.frame = CGRectMake(9, 50, 147, 44);
