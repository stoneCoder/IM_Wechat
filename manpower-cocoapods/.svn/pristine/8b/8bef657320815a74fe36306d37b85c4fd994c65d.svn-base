...
-(void)setMaxScale{
    ...
    CGFloat scale1 = screenSize.width / _photoImageView.frame.size.width;      // 图片/屏幕宽度比
    CGFloat scale2 = screenSize.height / _photoImageView.frame.size.height;      // 图片/屏幕宽度比
    _maxScale = MAX(MAX(scale1, scale2),2);
